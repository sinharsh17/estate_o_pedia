...
$city = $_SESSION['city'];
$minimum_expected_rent = $_SESSION['minimum_expected_rent'];
$maximum_expected_rent = $_SESSION['maximum_expected_rent'];
...
$query = "SELECT neighbourhood,city,minimum_expected_rent,maximum_expected_rent,property_status,property_type,bhk,amenities,bathrooms FROM rent where neighbourhood='$neighbourhood' AND city='$city' AND minimum_expected_rent='$minimum_expected_rent' AND maximum_expected_rent='$maximum_expected_rent' AND property_status='$property_status' AND property_type='$property_type' AND bhk='$bhk' AND amenities='$amenities' AND bathrooms='$bathrooms'";
...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $city = $row['city'];
        $minimum_expected_rent = $row['minimum_expected_rent'];
        $maximum_expected_rent = $row['maximum_expected_rent'];
    ...
    <div class="box-container">
        <div class="box">
            ...
            <div class="content">
                <div class="price">
                    <h3>₹
                        <?php echo $minimum_expected_rent?> - ₹
                        <?php echo $maximum_expected_rent?>
                    </h3>
                    <a href="#" class="fas fa-heart"></a>
...
<section class="agents" id="agents">
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <iframe class="map"
                src="https://www.google.com/maps/place/Whitefield,+Bengaluru,+Karnataka,+India/@12.9646408,77.6627108,13z/data=!3m1!4b1!4m6!3m5!1s0x3bae11f35d0dfc83:0x30cfa512d80115f9!8m2!3d12.9698196!4d77.7499721!16zL20vMDJfcmM4"
