...
<body>
    ...
    <?php
            if (isset($_POST['neighbourhood'])) {
                ...
                $sql = "INSERT INTO sell VALUES ('$neighbourhood','$city','$minimum_expected_price','$maximum_expected_price','$property_status','$property_type','$bhk','$amenities','$bathrooms');";
                // echo $sql;
        ...
        <form action="sell.php" method="post">
            ...
            <h3>sell your property quick</h3>
            ...
            <div class="inputBox">
                ...
                <select name="minimum_expected_price" id="minimum_expected_price">
                    <option value="" disabled hidden selected>minimum expected price</option>
                ...
                <select name="maximum_expected_price" id="maximum_expected_price">
                    <option value="" disabled hidden selected>maximum expected price</option>
